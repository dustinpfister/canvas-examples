...
* (done) a 'onFrame' event will fire for each frame starting from frame 0 to a maxFrame property of the button on the in state
* (done) a 'onOutEnd' event will fire when a button animation finishes going out of the canvas.
